...
| ------------- | -------- | ------ |  --- |
| [`< v1.15.0`](https://github.com/stackitcloud/gardener-extension-acl/releases/tag/v1.15.0) | gardenlet featureGate `UseUnifiedHTTPProxyPort` | Older versions of the ACL extension do not create the necessary Envoy filters for the new unified port `8443`. You should update to a newer version of the extension and reconcile all shoots that use it **BEFORE** enabling the feature gate. |
